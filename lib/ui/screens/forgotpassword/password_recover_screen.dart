...
class PasswordRecoverScreen extends BaseStatefulWidget{
  @override
  _PasswordRecoverScreenState  createState() => _PasswordRecoverScreenState();

}

class _PasswordRecoverScreenState extends BaseState<PasswordRecoverScreen> with BasicScreen {
  @override
          ...
          child:Padding(
            ...
            child: Column(
              children: [
                ...
                getSmallText(passwordRecovercontent,weight: FontWeight.w400,align: TextAlign.center,fontSize: SUBTITLE_FONT_SIZE),
                const SizedBox(height: 20,),
                      ...
                      child: RichText(
                        ...
                        text: const TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            TextSpan(text: resendEmail, style: TextStyle(fontWeight: FontWeight.w800,fontSize: SUBTITLE_FONT_SIZE,color: colorBlack)),
                          ],
                        ),
                      ),
                    ),
