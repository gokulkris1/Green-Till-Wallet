...
class RedeemedProductWebview extends BaseStatefulWidget {
  final String title;
  final String link;

  const RedeemedProductWebview({super.key, required this.title, required this.link});

  @override
  _RedeemedProductWebviewState createState() => _RedeemedProductWebviewState();
}

class _RedeemedProductWebviewState extends BaseState<RedeemedProductWebview>
    with BasicScreen {
